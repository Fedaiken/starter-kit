...
1. **One desk directs visible lane windows.** The window the owner types `/desk` in becomes the desk. Lanes are real terminal tabs the owner can click into and talk to. Subagents are retired for batched work — invisible workers cannot be stepped into or corrected mid-task.
...
11. **The desk never starts the next desk.** The owner does. (Open question from HAZELHURST: whether the save should leave the desk open, since typing `/desk` again after every save was unwelcome.)
